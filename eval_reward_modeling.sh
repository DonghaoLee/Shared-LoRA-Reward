...
torchrun --nproc_per_node=1 --master_port=${port} src/reward_modeling.py \
    ...
    --output_dir ./exp/gpt-j-6b-Reward/lr-5e-5-4epochs-lorar32-all/pslora/checkpoint-840 \
    --checkpoint_paths ./exp/gpt-j-6b-Reward/lr-5e-5-4epochs-lorar32-all/pslora/checkpoint-840/model-00001-of-00003.safetensors ./exp/gpt-j-6b-Reward/lr-5e-5-4epochs-lorar32-all/pslora/checkpoint-840/model-00002-of-00003.safetensors ./exp/gpt-j-6b-Reward/lr-5e-5-4epochs-lorar32-all/pslora/checkpoint-840/model-00003-of-00003.safetensors \
